...
const Home = () => {
  return (
    <div className="min-h-screen w-full relative bg-white text-gray-800 dark:bg-gray-900 dark:text-gray-200 transition-colors duration-500">
      ...
      <div className="back min-h-screen relative z-10">
        <Helmet>
          <title>Home</title>
        </Helmet>
